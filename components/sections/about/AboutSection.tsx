...
import { capabilityPlates, manifesto, siteConfig } from '../../../content/portfolio';
    ...
    <div className="mx-auto grid w-[min(1480px,100%)] grid-cols-1 gap-8 border-t border-[#111111]/20 pt-10 md:grid-cols-12 md:gap-5">
      ...
      >
        ...
        <a
          ...
          className="mt-2 inline-flex w-fit items-center gap-2 border-b border-[#111111]/30 pb-1 font-mono-ui text-xs uppercase text-[#111111]/65 transition hover:border-[#2457ff] hover:text-[#2457ff]"
        >
