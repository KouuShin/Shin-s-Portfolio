...
export function ResumeModal({ isOpen, onClose }: ResumeModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-4xl h-[90vh] bg-gray-900 shadow-xl border border-white/10 flex flex-col"
      ...
      >
        ...
        <div className="absolute top-4 right-4 z-10">
          <Button
            ...
            variant="ghost"
            size="sm"
            className="h-10 w-10 p-0 hover:bg-white/10 text-white"
          >
            <X className="h-5 w-5" />
